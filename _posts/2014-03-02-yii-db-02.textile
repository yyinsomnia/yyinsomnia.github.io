...
CDbConnection是对PDO的轻度封装，而CDbCommand则是对PDOStatement 和 sql语句的轻度封装。因为涉及到对常用sql的功能封装，所以该类代码达到了1600多行。逐一讲解意义不大，所以着重分析一些属性 and 
{% highlight php %}
$params
$_text
$_query
...
{% endhighlight %}
优先选择$_text返回，没有的时候才会对$_query buildQuery()
